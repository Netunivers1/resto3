...
var BoissonComponent = /** @class */ (function () {
     ...
     * @return void
    */
    BoissonComponent.prototype.pagination = function (page_param, limits) {
        var _this = this;
        ...
        if (is_paginate_allowed) {
            this.boissonsCharger = false;
            this.http.get(__WEBPACK_IMPORTED_MODULE_3__config_host__["a" /* urlApi */] + '/boisson/1/' + page_param + "/" + limits)
...
var DessertComponent = /** @class */ (function () {
     ...
     * @return void
    */
    DessertComponent.prototype.pagination = function (page_param, limits) {
        var _this = this;
        if (limits === void 0) { limits = 0; }
        var is_paginate_allowed = true;
        if (page_param == this.page_current && limits == 0)
        ...
        if (is_paginate_allowed) {
            this.dessertsCharger = false;
            this.http.get(__WEBPACK_IMPORTED_MODULE_5__config_host__["a" /* urlApi */] + '/dessert/1/' + page_param + "/" + limits)
                .map(function (response) { return response.json(); })
                .subscribe(function (data) {
...
var EntreeComponent = /** @class */ (function () {
     ...
     * @return void
    */
    EntreeComponent.prototype.pagination = function (page_param, limits) {
        var _this = this;
        if (limits === void 0) { limits = 0; }
        var is_paginate_allowed = true;
        if (page_param == this.page_current && limits == 0)
        ...
        if (is_paginate_allowed) {
            this.entreesCharger = false;
            this.http.get(__WEBPACK_IMPORTED_MODULE_5__config_host__["a" /* urlApi */] + '/entree/1/' + page_param + "/" + limits)
                .map(function (response) { return response.json(); })
                .subscribe(function (data) {
                _this.entrees = data.contain;
                _this.entreesCharger = (data.contain.length > 0) ? true : false;
                _this.p_prev = data.p_prev;
                _this.p_next = data.p_next;
                _this.page_current = data.p_current;
                _this.paginate_show = (data.count > _this.limits);
...
var MenuListComponent = /** @class */ (function () {
     ...
     * @return void
    */
    MenuListComponent.prototype.pagination = function (page_param, limits) {
        var _this = this;
        if (limits === void 0) { limits = 0; }
        var is_paginate_allowed = true;
        if (page_param == this.page_current && limits == 0)
        ...
        if (is_paginate_allowed) {
            ...
            var url = __WEBPACK_IMPORTED_MODULE_3__config_host__["a" /* urlApi */] + '/getlist/' + this.menuContainerTitle + '/' + this.menuContainerId + "/1";
            this.http.get(url + "/" + page_param + "/" + limits)
                .map(function (response) { return response.json(); })
                .subscribe(function (data) {
                _this.menuList = data.contain || [{ nom: "---", gm: "---", pm: "---" }];
    ...
    MenuListComponent.prototype.initializingDelete = function (values) {
        this.modif = values;
    };
    MenuListComponent.prototype.supprimerMenu = function (values) {
        ...
        this.http.post(url, values).subscribe(function (response) {
            ...
            _this.pagination(_this.page_current, _this.limits);
        });
    };
...
var MenuComponent = /** @class */ (function () {
    ...
    */
    MenuComponent.prototype.pagination = function (page_param, limits) {
        ...
        if (is_paginate_allowed) {
            this.menusCharger = false;
            this.http.get(__WEBPACK_IMPORTED_MODULE_5__config_host__["a" /* urlApi */] + '/menu3/1/' + page_param + "/" + limits)
                .map(function (response) { return response.json(); })
                .subscribe(function (data) {
